...
unsigned int show=270,dub=150;       //show是温度报警值2.7,   dub是电压报警值1.5
...
while(1)
{
    ...
    while(jud==1)//按下一次
    {
        ...
        efv = (max - min)*100/341;  //efv电压有效值，下面是输出
...
void ADC10_init(void) {
    ...
    ADC10CTL1 = INCH_6 + CONSEQ_0;//单通道单次转换
    ADC10AE0 |= BIT6;     //选择P1.0/A0来做ADC
}
